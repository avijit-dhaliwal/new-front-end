...
const suites = [
  {
    ...
    description:
      "Complete AI-powered marketing automation for agencies and businesses. Create campaigns, manage social media, and optimize conversions with intelligent insights.",
    features: [
      "Campaign Creation",
  ...
  },
  {
    ...
    description:
      "Specialized AI tools for real estate professionals. Generate property descriptions, qualify leads, schedule showings, and manage client communications.",
    features: [
  ...
  },
  {
    ...
    description:
      "Perfect for small retail businesses. Manage inventory, create product descriptions, handle customer service, and optimize your online presence.",
    features: [
  ...
  },
  {
    ...
    description:
      "HIPAA-compliant AI tools for healthcare providers. Manage appointments, handle patient inquiries, generate reports, and streamline administrative tasks.",
    features: [
      "Appointment Scheduling",
      ...
      <div className="pt-20">
        ...
        <div className="text-center max-w-4xl mx-auto px-6 sm:px-8 mb-16 relative">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to right, rgba(249, 115, 22, 0.3), rgba(234, 88, 12, 0.3))",
              filter: "blur(60px)",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {suites.map((suite, index) => (
              ...
              >
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${suite.bgColor} opacity-0 group-hover:opacity-10 transition-opacity duration-150`}
                />

                <div className="relative z-10">
                  {/* Icon */}
                  <div
                    className={`w-16 h-16 bg-gradient-to-br ${suite.color} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-150`}
                  >
                  ...
                  <div className="mb-6">
                    ...
                    <div className="space-y-2">
                      ...
                      {expandedSuites.has(suite.id) &&
                        suite.included.slice(4).map((feature, featureIndex) => (
                          <motion.div
                            key={featureIndex + 4}
                  ...
                  <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <p className="text-xs text-yellow-800">
                      <strong>Need more?</strong> Custom features, integrations,
                      and enterprise solutions available.
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    Tailored AI tools for your specific use cases
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    Personalized onboarding and ongoing assistance
                  </p>
                </div>
              </div>
        ...
        >
          ...
          <p className="text-gray-600 mb-8">
            Get started with our AI suites today and see the difference AI can
            make.
          </p>
          <div className="flex justify-center">
            <Link href="/get-started">
