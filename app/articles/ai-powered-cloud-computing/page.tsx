    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="pt-20">
        ...
        >
          ...
          <img src={article_image_1.src} alt="image_1" />
            ...
            <div className="space-y-8">
                ...
                <div className="grid gap-8">
                  <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                    <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center">
                      <span className="w-8 h-8 bg-gray-600 text-white rounded-full flex items-center justify-center text-sm font-bold mr-3">
                        1
                      </span>
                ...
                <div className="bg-gray-50 border-l-4 border-gray-400 p-6 rounded-r-xl">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-4">
                      <span className="w-6 h-6 bg-gray-600 text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0 mt-1">
                        1
                      </span>
                      <div>
              ...
              <section className="space-y-6">
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-4">
                      <span className="w-8 h-8 bg-gray-600 text-white rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0 mt-1">
                        1
                      </span>
                      <div>
                        <h4 className="font-semibold text-gray-800 mb-2">
          ...
          <div className="mt-16 p-8 bg-gradient-to-r from-accent-500 to-accent-600 rounded-2xl text-white text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact"
                className="bg-white text-accent-500 font-semibold py-3 px-6 rounded-xl hover:bg-gray-100 transition-all duration-300"
              >
                Contact Us
              </Link>
              <Link
                href="/get-started"
                className="border-2 border-white text-white font-semibold py-3 px-6 rounded-xl hover:bg-white hover:text-accent-500 transition-all duration-300"
              >
                Get Started
              </Link>
            </div>
