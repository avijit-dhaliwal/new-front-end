...
export default function ChatBot({ onClose }: ChatBotProps) {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      content: "Hello! I'm your CHADIS healthcare assistant. I can help you with questions about pediatric health screening, developmental assessments, and patient care guidance. What would you like to know?",
      sender: 'bot',
      timestamp: new Date()
    }
  ])
  ...
  const sendMessage = async () => {
    ...
    try {
      // Call Cloudflare Worker for Gemini AI
      const response = await fetch('https://chadis-chat.voidinfrastructuretechnologies.workers.dev', {
        method: 'POST',
        headers: {
    ...
    >
      ...
      <div className="flex items-center justify-between p-6 border-b border-gray-200">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900">CHADIS Chat Assistant</h3>
        ...
        <div className="flex space-x-4">
          <div className="flex-1">
            <textarea
              ...
              placeholder="Ask about pediatric health screening, development assessments, or CHADIS features..."
